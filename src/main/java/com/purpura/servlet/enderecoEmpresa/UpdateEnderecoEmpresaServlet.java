...
public class UpdateEnderecoEmpresaServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (empresa == null) {
                EnderecoEmpresaViewSetErro(
                        request, response, dao, listaEnderecos,
            ...
            if (empresa.getCAtivo() != '1') {
                EnderecoEmpresaViewSetErro(
                        request, response, dao, listaEnderecos,
                        "Não foi possível atualizar o endereço! Insira uma empresa ativa.",
                        lista, caminho
                );
                return;
            }
            ...
            // Redireciona para a listagem de endereços após sucesso
